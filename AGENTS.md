...
agents:
  - name: planner
    ...
    description: |
      Architecture and design decisions for the Trade Octane Angular frontend.
  ...
  - name: executor
    model: claude-sonnet-4-6
    description: |
      Scaffolds Angular components and services for Trade Octane.
  ...
  - name: researcher
    ...
    description: |
      Fast lookup and environment tasks for Trade Octane.
