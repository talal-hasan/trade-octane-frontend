...
export const MOCK_USERS: Record<string, UserContext> = {
  RSM: {
    ...
    name: 'Ahmed Bilal',
    roles: ['RSM'],
    regions: ['Central Punjab', 'Lahore'],
    brands: ["Olper's", 'Tarang'],
    permissions: [
      'BUDGET_VIEW',
      'BUDGET_CREATE',
      'SCHEME_VIEW',
  ...
  HEAD_OF_SALES: {
    ...
    name: 'Farhan Malik',
    roles: ['HEAD_OF_SALES'],
    regions: ['Central Punjab', 'Lahore', 'South', 'KPK'],
    brands: ["Olper's", 'Tarang', 'Dairy Omung'],
    permissions: [
      'BUDGET_VIEW',
      'BUDGET_APPROVE',
      'SCHEME_VIEW',
  ...
  ADMIN: {
    ...
    name: 'Nida Sheikh',
    roles: ['ADMIN'],
    regions: ['Central Punjab', 'Lahore', 'South', 'KPK', 'Islamabad'],
    brands: ["Olper's", 'Tarang', 'Dairy Omung'],
    permissions: [
      'BUDGET_VIEW',
      'BUDGET_CREATE',
